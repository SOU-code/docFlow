        ...
        <div className="flex items-center justify-between w-full h-full p-8">
          ...
          <div className="flex flex-row gap-4">
            <div className="social-icon">
              <FaFacebookF size={22} color="#7c3aed" />
            </div>
            <div className="social-icon">
              <FaInstagram size={22} color="#7c3aed" />
            </div>
            <div className="social-icon">
              <FaTwitter size={22} color="#7c3aed" />
            </div>
            <div className="social-icon">
              <FaGithub size={22} color="#7c3aed" />
            </div>
            <div className="social-icon">
              <FaYoutube size={22} color="#7c3aed" />
            </div>
          </div>
        </div>
      </section>
